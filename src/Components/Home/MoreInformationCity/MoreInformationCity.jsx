...
const MoreInformationCity = (props) => {
    ...
    return (
        <section className="flex flex-col items-center w-full text-black md:flex-warp">
			...
			<div className="flex aling-center px-10 py-8 mb-4 shadow-md bg-blue-200 rounded-lg bg-blue">
			...
			<div className="flex justify-evenly py-8 mb-6 bg-blue-200 shadow-md rounded-xl md:flex-col md:mx-4">
			...
			<div className=" p-8 mb-8 bg-blue-200 shadow-md text-center rounded-xl md:flex-col md:mx-4 md:py-10">
				<div>
